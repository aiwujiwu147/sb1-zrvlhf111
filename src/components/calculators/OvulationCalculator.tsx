...
import OvulationCalculatorDocs from './OvulationCalculatorDocs';
...
export default function OvulationCalculator({ calculator }: CalculatorProps) {
  ...
  const calculateOvulation = (): OvulationResult => {
